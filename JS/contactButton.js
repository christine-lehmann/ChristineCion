...
firstPlatform.addEventListener('click',()=>{
    window.open("https://twitter.com/ChristineCion");
});
secondPlatform.addEventListener('click',()=>{
    window.open("mailto:cion.c.bscs@gmail.com");
});
thirdPlatform.addEventListener('click',()=>{
    window.open("https://github.com/christine-lehmann");
});
fourthPlatform.addEventListener('click',()=>{
    window.open("https://www.linkedin.com/in/christinecion");
});
